...
En vez de que su definición esté dividida en líneas de comandos echo, pensamos que es mejor crear y definir este archivo Dockerfile dentro del directorio sample-app. Luego lo copiamos en el script bash, igual que los demás archivos.
